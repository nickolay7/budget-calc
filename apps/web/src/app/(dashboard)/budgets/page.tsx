/**
 * Страница управления бюджетами (`/budgets`).
 * Содержит заголовок, сводку по бюджетам (всего, потрачено, осталось),
 * карточки прогресса по каждой категории и пустое состояние.
 */
"use client";
...
/**
 * Страница со списком бюджетов по категориям.
 * Отображает сводку расходов и прогресс-бары для каждого бюджета.
 *
 * @returns JSX-разметка страницы бюджетов.
 */
