...
/**
 * Компонент списка транзакций с фильтрацией и пагинацией.
 *
 * Состояния рендеринга:
 * - Загрузка: скелетон из 5 строк (TransactionSkeleton).
 * - Ошибка: карточка с сообщением и кнопкой Retry.
 * - Пусто: карточка с призывом добавить первую транзакцию.
 * - Данные: список транзакций с фильтрами и пагинацией.
 *
 * @returns JSX-разметка списка транзакций.
 */
